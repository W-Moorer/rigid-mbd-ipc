...
\newcommand{\tabnewline}{\ \newline} %2025-05-6: add "\ " at the beginning to avoid problems with newer pdflatex
...
\end{center}
\vspace{0.2cm}
{\small Exudyn version = \input{version.txt}}\\
...
%+++++++++++++++++++++++++++++++++++++
\mysectionlabel{Python utility functions}{sec:pythonUtilityFunctions}
...
\mysubsectionlabel{Utility: ResultsMonitor}{sec:resultsMonitor}
...
\mysectionlabel{Objects, nodes, markers, loads and sensors reference manual}{sec:item:reference:manual}
...
\mysectionlabel{Structures and Settings}{sec:settingsStructures}
...
%+++++++++++++++++++++++++++++++++++++
\mysectionlabel{Issues and bugs}{sec:issueTracker}
\iftoggle{compileAll}
{
