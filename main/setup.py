...
#		'-Wall',
    ...
    if sys.platform == 'darwin':
        ...
        darwin_opts = ['-stdlib=libc++', '-mmacosx-version-min=11.0'] #initially worked for github actions; for c++17 support (not working on older MacOSX)
        # darwin_opts = ['-stdlib=libc++', '-mmacosx-version-min=10.9'] #changed for github actions 2024-06-04;
